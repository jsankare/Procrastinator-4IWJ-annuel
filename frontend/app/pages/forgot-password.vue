<template>
  <div class="min-h-screen flex items-center justify-center p-6 bg-primary text-text">
    <div class="w-full max-w-md rounded-xl bg-secondary p-8 border border-white/10 shadow-lg">
      <h1 class="text-2xl font-bold mb-6">Réinitialiser mon mot de passe</h1>
      <form class="space-y-4">
        ...
        <button type="submit" class="w-full rounded-md bg-accent text-secondary font-medium py-2 hover:opacity-90">Demander un nouveau mot de passe</button>
      </form>
