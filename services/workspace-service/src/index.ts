...
const SERVICE_NAME = process.env.SERVICE_NAME || 'workspace-service';
...
app.get('/health', async (req: Request, res: Response) => {
  try {
    ...
    const workspaceStats = await WorkspaceModel.getStats();
...
app.get('/info', (req: Request, res: Response) => {
  res.json({
    ...
    endpoints: {
      ...
      joinWorkspace: 'POST /join',
      getWorkspace: 'GET /:id',
      updateWorkspace: 'PUT /:id (owner/admin only)',
      leaveWorkspace: 'POST /:id/leave',
      deleteWorkspace: 'DELETE /:id (owner only)',
    },
